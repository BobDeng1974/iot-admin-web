<template>
  <div class="meiju-lua-list-warp">
    <div class="title-mip">
      <con-header :title-icon="addProductsIcon" title="美居lua列表" :hasBottomBorder="true"></con-header>
    </div>
    <!-- 查询部分 -->
    <div class="mip-check">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="品类">
              <el-select filterable v-model="formInline.typeCode" placeholder="请选择" clearable>
      ...
      <div>
        <el-row v-authority="'b1_mjLuaListTag'" class="applicationManagement-row" style="display: flex; justify-content: flex-end;">
      ...
      <el-table :data="tableData" style="width: 100%" class='table'>
        ...
        <el-table-column label="操作" align="center" fixed='right' width="130">
          <template slot-scope="scope">
            ...
            <span class="mine-down" @click="showInfo(scope.row)" v-authority="'b1_meijuCheckEnv'">查看环境</span>
          </template>
        </el-table-column>
      </el-table>
    </div>
