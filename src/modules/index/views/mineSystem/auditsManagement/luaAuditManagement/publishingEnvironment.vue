<template>
    <div class="pub-lua-warp" v-loading="loading">
        ...
        <div>
            ...
            <li v-for="(item, index) in testlist" :key="index">
                ...
                <div v-if="item.publicStatus === 99">
                    <el-row>
                        <el-col :span="8"><div>{{item.LuaEvn === 0 ? '美居app' : '云端'}}</div></el-col>
                        <el-col :span="8"><div @click="publickOnce(item)" class="btn-submit" v-authority="'b1_luaPublishingEnvironment'">提交发布</div></el-col>
                ...
                <div v-if="item.publicStatus === 2">
                    <el-row>
                        ...
                        <el-col :span="8"><div @click="publickAgain(item)" class="btn-submit" v-authority="'b1_luaPublishingEnvironment'">重试</div></el-col>
                    </el-row>
                </div>
        ...
        <div class="dialog-footer" v-if="show">
          <el-button type="primary" @click="enter" v-authority="'b1_luaConfirmationFormal'">发布正式环境成功</el-button>
        </div>
    </div>
</template>
