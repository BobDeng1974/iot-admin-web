  ...
  <div class="module-sdk">
    ...
    <div class="query-wrapper clearfix">
      ...
      >
        ...
        <el-row>
          <el-col v-authority="'b1_moduleSDKManagement_list'" :span="24">
            <el-button
      ...
      <div class='sdk-add-btn'>
        <span class="btn-select">
          <el-button type="primary" v-authority="'b1_moduleSDKManagement_create'"   @click="addSdk">新增模块SDK</el-button>
        </span>
      </div>
    </div>
      <!--Lua协议列表-->
    <div class="table-wrapper">
      <el-table v-loading="loading" class="table" :data="dataList" style="width: 100%">
        ...
        <el-table-column label="操作" width="100">
          <template slot-scope="scope">
            <!-- v-authority="" -->
            <el-button v-if="scope.row.status!==3" type="text" size="small" v-authority="'b1_moduleSDKManagement_get'" @click="detailSdk(scope.row)">详情</el-button>
            <el-button  v-if="scope.row.status===2" type="text" size="small" v-authority="'b1_moduleSDKManagement_publish'"  class="opt-btn"  @click="issueSdk(scope.row)">发布</el-button>
            <el-button  v-if="scope.row.status===3" class="" type="text" size="small" v-authority="'b1_moduleSDKManagement_get'"  @click="editSdk(scope.row)">详情</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
