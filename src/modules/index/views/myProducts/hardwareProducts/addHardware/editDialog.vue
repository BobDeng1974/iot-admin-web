...
export default {
  ...
  methods: {
    hanlderData() {
      this.addSdkForm = this.dialogData;
      if (this.dialogData.succPic) {
        this.fileList.splice(0, 1, {
          name: this.dialogData.picFileOrginalName,
          url: this.dialogData.succPic
        });
      }
      if (this.dialogData.doc) {
        this.succfileList.splice(0, 1, {
          name: this.dialogData.docFileOrginalName,
          url: this.dialogData.doc
        });
      }
      debugger;
    },
